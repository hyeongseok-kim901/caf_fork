...
#define HWIO_TLMM_UFS_REF_CLK_CTL_ADDR			(TLMM_REG_REG_BASE + 0x000d7000)
...
//-----------------------------------------------------------------//
#if defined(CONFIG_ARCH_LAHAINA)
/* reference : ufs_phy_hwio_v2.h */
#define QSERDES_TX0_PRE_EMPH	TX_OFF(0, 0xe8)
#define QSERDES_TX1_PRE_EMPH	TX_OFF(1, 0xe8)
...
//-----------------------------------------------------------------//
#elif defined(CONFIG_ARCH_SM8150) || defined(CONFIG_ARCH_KONA)
